                    ...
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <th class="table-id">ID</th><th class="table-title">租户名称</th><th class="table-type">性别</th><th class="table-author am-hide-sm-only">年龄</th><th class="table-date am-hide-sm-only">联系方式</th><th class="table-set">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <td><a href="#">高琛</a></td>
                                <td>男</td>
                                <td class="am-hide-sm-only">25</td>
                                <td class="am-hide-sm-only">137777777689</td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
